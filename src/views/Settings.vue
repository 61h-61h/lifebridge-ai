<template>
  <div class="p-4 md:p-8 max-w-2xl mx-auto space-y-6">
    <div class="border-b border-slate-100 pb-4"><h1 class="text-2xl font-bold text-slate-800">AI 大脑神经中心</h1><p class="text-xs text-slate-400 mt-1">配置国内大模型密钥，数据纯前端存储在你的个人浏览器中，绝对安全。</p></div>
    <div class="bg-indigo-50 border border-indigo-100 rounded-3xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
      <span class="text-sm font-semibold text-indigo-900 whitespace-nowrap">🧥 设定当前全站默认思维大脑</span>
